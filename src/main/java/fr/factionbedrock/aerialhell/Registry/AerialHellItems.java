...
public class AerialHellItems
{
    ...
    //shurikens
    public static final DeferredItem<Item> IRON_SHURIKEN = ITEMS.register(Keys.IRON_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.IRON_SHURIKEN).rarity(Rarity.COMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_IRON_SHURIKEN))));
    public static final DeferredItem<Item> GOLD_SHURIKEN = ITEMS.register(Keys.GOLD_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.GOLD_SHURIKEN).rarity(Rarity.COMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_GOLD_SHURIKEN))));
    public static final DeferredItem<Item> DIAMOND_SHURIKEN = ITEMS.register(Keys.DIAMOND_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.DIAMOND_SHURIKEN).rarity(Rarity.COMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_DIAMOND_SHURIKEN))));
    public static final DeferredItem<Item> NETHERITE_SHURIKEN = ITEMS.register(Keys.NETHERITE_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.NETHERITE_SHURIKEN).rarity(Rarity.UNCOMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_NETHERITE_SHURIKEN))));
    public static final DeferredItem<Item> RUBY_SHURIKEN = ITEMS.register(Keys.RUBY_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_SHURIKEN).rarity(Rarity.COMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_RUBY_SHURIKEN))));
    public static final DeferredItem<Item> AZURITE_SHURIKEN = ITEMS.register(Keys.AZURITE_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AZURITE_SHURIKEN).rarity(Rarity.COMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_AZURITE_SHURIKEN))));
    public static final DeferredItem<Item> MAGMATIC_GEL_SHURIKEN = ITEMS.register(Keys.MAGMATIC_GEL_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SHURIKEN).rarity(AerialHellRarities.FROZEN.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_MAGMATIC_GEL_SHURIKEN))));
    public static final DeferredItem<Item> VOLUCITE_SHURIKEN = ITEMS.register(Keys.VOLUCITE_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_SHURIKEN).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_VOLUCITE_GEL_SHURIKEN))));
    public static final DeferredItem<Item> OBSIDIAN_SHURIKEN = ITEMS.register(Keys.OBSIDIAN_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_SHURIKEN).rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_OBSIDIAN_SHURIKEN))));
    public static final DeferredItem<Item> LUNATIC_CRYSTAL_SHURIKEN = ITEMS.register(Keys.LUNATIC_CRYSTAL_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_CRYSTAL_SHURIKEN).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_LUNATIC_CRYSTAL_SHURIKEN))));
    public static final DeferredItem<Item> ARSONIST_SHURIKEN = ITEMS.register(Keys.ARSONIST_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_SHURIKEN).rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_ARSONIST_SHURIKEN))));
    public static final DeferredItem<Item> LIGHTNING_SHURIKEN = ITEMS.register(Keys.LIGHTNING_SHURIKEN.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LIGHTNING_SHURIKEN).rarity(Rarity.UNCOMMON).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.THROW_LIGHTNING_SHURIKEN))));
    ...
    public static final DeferredItem<Item> SHADOW_FRUIT_STEW = ITEMS.register(Keys.SHADOW_FRUIT_STEW.identifier().getPath(), () -> new SkySoupItem(new Item.Properties().setId(Keys.SHADOW_FRUIT_STEW).rarity(AerialHellRarities.CORRUPTED.getValue()).stacksTo(16).food(AerialHellFoods.Properties.SHADOW_FRUIT_STEW, AerialHellFoods.Consumables.SHADOW_FRUIT_STEW)));
    public static final DeferredItem<Item> SOLID_ETHER_SOUP = ITEMS.register(Keys.SOLID_ETHER_SOUP.identifier().getPath(), () -> new SkySoupItem(new Item.Properties().setId(Keys.SOLID_ETHER_SOUP).rarity(Rarity.COMMON).stacksTo(16).food(AerialHellFoods.Properties.SOLID_ETHER_SOUP, AerialHellFoods.Consumables.SOLID_ETHER_SOUP)));
    public static final DeferredItem<Item> VIBRANT_SOLID_ETHER_SOUP = ITEMS.register(Keys.VIBRANT_SOLID_ETHER_SOUP.identifier().getPath(), () -> new SkySoupItem(new Item.Properties().setId(Keys.VIBRANT_SOLID_ETHER_SOUP).rarity(AerialHellRarities.VIBRANT.getValue()).stacksTo(16).food(AerialHellFoods.Properties.VIBRANT_SOLID_ETHER_SOUP, AerialHellFoods.Consumables.VIBRANT_SOLID_ETHER_SOUP)));
    public static final DeferredItem<Item> FROZEN_SOLID_ETHER_SOUP = ITEMS.register(Keys.FROZEN_SOLID_ETHER_SOUP.identifier().getPath(), () -> new SkySoupItem(new Item.Properties().setId(Keys.FROZEN_SOLID_ETHER_SOUP).rarity(AerialHellRarities.FROZEN.getValue()).stacksTo(16).food(AerialHellFoods.Properties.FROZEN_SOLID_ETHER_SOUP, AerialHellFoods.Consumables.FROZEN_SOLID_ETHER_SOUP)));
    ...
    //tools
    public static final DeferredItem<Item> SKY_WOOD_PICKAXE = ITEMS.register(Keys.SKY_WOOD_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_PICKAXE).pickaxe(AerialHellToolMaterials.SKY_WOOD, 1.0F, -2.8F)));
    public static final DeferredItem<Item> STELLAR_STONE_PICKAXE = ITEMS.register(Keys.STELLAR_STONE_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_PICKAXE).pickaxe(AerialHellToolMaterials.STELLAR_STONE, 1.0F, -2.8F)));
    public static final DeferredItem<Item> RUBY_PICKAXE = ITEMS.register(Keys.RUBY_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_PICKAXE).pickaxe(AerialHellToolMaterials.RUBY, 1.0F, -2.8F)));
    public static final DeferredItem<Item> AZURITE_PICKAXE = ITEMS.register(Keys.AZURITE_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_PICKAXE).pickaxe(AerialHellToolMaterials.AZURITE, 1.0F, -2.8F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_PICKAXE = ITEMS.register(Keys.MAGMATIC_GEL_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_PICKAXE).pickaxe(AerialHellToolMaterials.MAGMATIC_GEL, 1.0F, -2.8F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL))));
    public static final DeferredItem<Item> OBSIDIAN_PICKAXE = ITEMS.register(Keys.OBSIDIAN_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_PICKAXE).pickaxe(AerialHellToolMaterials.OBSIDIAN, 1.0F, -2.8F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_PICKAXE = ITEMS.register(Keys.VOLUCITE_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_PICKAXE).pickaxe(AerialHellToolMaterials.VOLUCITE, 1.0F, -2.8F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.VOLUCITE_POWER))));
    public static final DeferredItem<Item> LUNATIC_PICKAXE = ITEMS.register(Keys.LUNATIC_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_PICKAXE).pickaxe(AerialHellToolMaterials.LUNATIC, 1.0F, -2.8F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL))));
    public static final DeferredItem<Item> ARSONIST_PICKAXE = ITEMS.register(Keys.ARSONIST_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_PICKAXE).pickaxe(AerialHellToolMaterials.ARSONIST, 1.0F, -2.8F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL))));

    public static final DeferredItem<Item> MAGMA_CUBE_PICKAXE = ITEMS.register(Keys.MAGMA_CUBE_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMA_CUBE_PICKAXE).pickaxe(AerialHellToolMaterials.OBSIDIAN, 1.0F, -2.8F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMA_CUBE))));
    public static final DeferredItem<Item> STELLAR_STONE_BREAKER = ITEMS.register(Keys.STELLAR_STONE_BREAKER.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_BREAKER).pickaxe(AerialHellToolMaterials.BREAKER, 1.0F, -2.8F).rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MINE_STONE_FAST))));

    public static final DeferredItem<Item> SKY_WOOD_SHOVEL = ITEMS.register(Keys.SKY_WOOD_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_SHOVEL).shovel(AerialHellToolMaterials.SKY_WOOD, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> STELLAR_STONE_SHOVEL = ITEMS.register(Keys.STELLAR_STONE_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().shovel(AerialHellToolMaterials.STELLAR_STONE, 1.5F, -3.0F).setId(Keys.STELLAR_STONE_SHOVEL).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> RUBY_SHOVEL = ITEMS.register(Keys.RUBY_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_SHOVEL).shovel(AerialHellToolMaterials.RUBY, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> AZURITE_SHOVEL = ITEMS.register(Keys.AZURITE_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new  AerialHellItem.Properties().setId(Keys.AZURITE_SHOVEL).shovel(AerialHellToolMaterials.AZURITE, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> MAGMATIC_GEL_SHOVEL = ITEMS.register(Keys.MAGMATIC_GEL_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SHOVEL).shovel(AerialHellToolMaterials.MAGMATIC_GEL, 1.5F, -3.0F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> OBSIDIAN_SHOVEL = ITEMS.register(Keys.OBSIDIAN_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_SHOVEL).shovel(AerialHellToolMaterials.OBSIDIAN, 1.5F, -3.0F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> VOLUCITE_SHOVEL = ITEMS.register(Keys.VOLUCITE_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_SHOVEL).shovel(AerialHellToolMaterials.VOLUCITE, 1.5F, -3.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.VOLUCITE_POWER)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> LUNATIC_SHOVEL = ITEMS.register(Keys.LUNATIC_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_SHOVEL).shovel(AerialHellToolMaterials.LUNATIC, 1.5F, -3.0F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> ARSONIST_SHOVEL = ITEMS.register(Keys.ARSONIST_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_SHOVEL).shovel(AerialHellToolMaterials.ARSONIST, 1.5F, -3.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));

    public static final DeferredItem<Item> MAGMA_CUBE_SHOVEL = ITEMS.register(Keys.MAGMA_CUBE_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMA_CUBE_SHOVEL).shovel(AerialHellToolMaterials.OBSIDIAN, 1.5F, -3.0F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMA_CUBE)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));

    public static final DeferredItem<Item> SKY_WOOD_AXE = ITEMS.register(Keys.SKY_WOOD_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_AXE).axe(AerialHellToolMaterials.SKY_WOOD, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> STELLAR_STONE_AXE = ITEMS.register(Keys.STELLAR_STONE_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_AXE).axe(AerialHellToolMaterials.STELLAR_STONE, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> RUBY_AXE = ITEMS.register(Keys.RUBY_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_AXE).axe(AerialHellToolMaterials.RUBY, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> AZURITE_AXE = ITEMS.register(Keys.AZURITE_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AZURITE_AXE).axe(AerialHellToolMaterials.AZURITE, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> MAGMATIC_GEL_AXE = ITEMS.register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_AXE).axe(AerialHellToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> OBSIDIAN_AXE = ITEMS.register(Keys.OBSIDIAN_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_AXE).axe(AerialHellToolMaterials.OBSIDIAN, 6.0F, -3.1F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> VOLUCITE_AXE = ITEMS.register(Keys.VOLUCITE_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_AXE).axe(AerialHellToolMaterials.VOLUCITE, 6.0F, -3.1F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.VOLUCITE_POWER)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> LUNATIC_AXE = ITEMS.register(Keys.LUNATIC_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_AXE).axe(AerialHellToolMaterials.LUNATIC, 6.0F, -3.1F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> ARSONIST_AXE = ITEMS.register(Keys.ARSONIST_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_AXE).axe(AerialHellToolMaterials.ARSONIST, 6.0F, -3.1F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));

    public static final DeferredItem<Item> HEAVY_AXE = ITEMS.register(Keys.HEAVY_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HEAVY_AXE).axe(AerialHellToolMaterials.HEAVY, 6.0F, -3.5F, AttributeEntry.movementSpeed(-0.1F)).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> AXE_OF_LIGHT = ITEMS.register(Keys.AXE_OF_LIGHT.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AXE_OF_LIGHT).axe(AerialHellToolMaterials.LUNATIC, 5.0F, -3.1F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SPREAD_LIGHT)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> CURSED_AXE = ITEMS.register(Keys.CURSED_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_AXE).axe(AerialHellToolMaterials.SHADOW, 2.0F, -3.2F).rarity(AerialHellRarities.CORRUPTED.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.CURSED_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> BERSERK_AXE = ITEMS.register(Keys.BERSERK_AXE.identifier().getPath(), () -> new BerserkAxeItem(new AerialHellItem.Properties().setId(Keys.BERSERK_AXE).axe(AerialHellToolMaterials.ARSONIST, 4.0F, -2.5F).rarity(AerialHellRarities.MYTHICAL.getValue()).useInteraction(AerialHellItem.UseInteractionType.AXE)));

    public static final DeferredItem<Item> SKY_WOOD_HOE = ITEMS.register(Keys.SKY_WOOD_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_HOE).hoe(AerialHellToolMaterials.SKY_WOOD, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> STELLAR_STONE_HOE = ITEMS.register(Keys.STELLAR_STONE_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_HOE).hoe(AerialHellToolMaterials.STELLAR_STONE, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> RUBY_HOE = ITEMS.register(Keys.RUBY_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_HOE).hoe(AerialHellToolMaterials.RUBY, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> AZURITE_HOE = ITEMS.register(Keys.AZURITE_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AZURITE_HOE).hoe(AerialHellToolMaterials.AZURITE, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> MAGMATIC_GEL_HOE = ITEMS.register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HOE).hoe(AerialHellToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL)).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> OBSIDIAN_HOE = ITEMS.register(Keys.OBSIDIAN_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_HOE).hoe(AerialHellToolMaterials.OBSIDIAN, 0.0F, -3.0F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> VOLUCITE_HOE = ITEMS.register(Keys.VOLUCITE_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_HOE).hoe(AerialHellToolMaterials.VOLUCITE, 0.0F, -3.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.VOLUCITE_POWER)).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    ...
    public static final DeferredItem<Item> STELLAR_STONE_SWORD = ITEMS.register(Keys.STELLAR_STONE_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_SWORD).sword(AerialHellToolMaterials.STELLAR_STONE, 3, -2.4F)));
    public static final DeferredItem<Item> RUBY_SWORD = ITEMS.register(Keys.RUBY_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_SWORD).sword(AerialHellToolMaterials.RUBY, 3, -2.4F)));
    public static final DeferredItem<Item> AZURITE_SWORD = ITEMS.register(Keys.AZURITE_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_SWORD).sword(AerialHellToolMaterials.AZURITE, 3, -2.4F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_SWORD = ITEMS.register(Keys.MAGMATIC_GEL_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SWORD).sword(AerialHellToolMaterials.MAGMATIC_GEL, 3, -2.4F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL))));
    public static final DeferredItem<Item> OBSIDIAN_SWORD = ITEMS.register(Keys.OBSIDIAN_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_SWORD).sword(AerialHellToolMaterials.OBSIDIAN, 3, -2.4F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_SWORD = ITEMS.register(Keys.VOLUCITE_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_SWORD).sword(AerialHellToolMaterials.VOLUCITE, 3, -2.4F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.VOLUCITE_POWER))));
    public static final DeferredItem<Item> LUNATIC_SWORD = ITEMS.register(Keys.LUNATIC_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_SWORD).sword(AerialHellToolMaterials.LUNATIC, 3, -2.4F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL))));
    public static final DeferredItem<Item> ARSONIST_SWORD = ITEMS.register(Keys.ARSONIST_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_SWORD).sword(AerialHellToolMaterials.ARSONIST, 3, -2.4F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL))));
    ...
    public static final DeferredItem<Item> RANDOM_SWORD = ITEMS.register(Keys.RANDOM_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RANDOM_SWORD).sword(AerialHellToolMaterials.RUBY, 2, -2.4F).fireResistant().rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.RANDOM_SWORD))));
    public static final DeferredItem<Item> DISLOYAL_SWORD = ITEMS.register(Keys.DISLOYAL_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.DISLOYAL_SWORD).sword(AerialHellToolMaterials.LUNATIC, 2, -2.4F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.DISADVANTAGE_OPPONENT))));
    public static final DeferredItem<Item> CURSED_SWORD = ITEMS.register(Keys.CURSED_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_SWORD).sword(AerialHellToolMaterials.SHADOW, 1, -2.5F).fireResistant().rarity(AerialHellRarities.CORRUPTED.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.CURSED_TOOL))));
    public static final DeferredItem<Item> ABSOLUTE_ZERO_SWORD = ITEMS.register(Keys.ABSOLUTE_ZERO_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ABSOLUTE_ZERO_SWORD).sword(AerialHellToolMaterials.LUNATIC, 2, -2.4F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ABSOLUTE_ZERO))));
    public static final DeferredItem<Item> SWORD_OF_LIGHT = ITEMS.register(Keys.SWORD_OF_LIGHT.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SWORD_OF_LIGHT).sword(AerialHellToolMaterials.LUNATIC, 2, -2.4F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SPREAD_LIGHT))));
    public static final DeferredItem<Item> ANTIDOTE_SWORD = ITEMS.register(Keys.ANTIDOTE_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ANTIDOTE_SWORD).sword(AerialHellToolMaterials.RUBY, 4, -2.4F).fireResistant().rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ANTIDOTE_SWORD))));
    ...
    public static final DeferredItem<Item> RUBY_CHESTPLATE = ITEMS.register(Keys.RUBY_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> RUBY_LEGGINGS = ITEMS.register(Keys.RUBY_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> RUBY_BOOTS = ITEMS.register(Keys.RUBY_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_BOOTS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.BOOTS)));

    public static final DeferredItem<Item> AZURITE_HELMET = ITEMS.register(Keys.AZURITE_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_HELMET).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.HELMET)));
    public static final DeferredItem<Item> AZURITE_CHESTPLATE = ITEMS.register(Keys.AZURITE_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> AZURITE_LEGGINGS = ITEMS.register(Keys.AZURITE_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> AZURITE_BOOTS = ITEMS.register(Keys.AZURITE_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.BOOTS)));

    public static final DeferredItem<Item> OBSIDIAN_HELMET = ITEMS.register(Keys.OBSIDIAN_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_HELMET).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.HELMET).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> OBSIDIAN_CHESTPLATE = ITEMS.register(Keys.OBSIDIAN_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.CHESTPLATE).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> OBSIDIAN_LEGGINGS = ITEMS.register(Keys.OBSIDIAN_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> OBSIDIAN_BOOTS = ITEMS.register(Keys.OBSIDIAN_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_BOOTS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.BOOTS).rarity(Rarity.EPIC)));

    public static final DeferredItem<Item> VOLUCITE_HELMET = ITEMS.register(Keys.VOLUCITE_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_HELMET).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.HELMET).rarity(AerialHellRarities.VIBRANT.getValue())));
    public static final DeferredItem<Item> VOLUCITE_CHESTPLATE = ITEMS.register(Keys.VOLUCITE_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.CHESTPLATE).rarity(AerialHellRarities.VIBRANT.getValue())));
    public static final DeferredItem<Item> VOLUCITE_LEGGINGS = ITEMS.register(Keys.VOLUCITE_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.LEGGINGS).rarity(AerialHellRarities.VIBRANT.getValue())));
    public static final DeferredItem<Item> VOLUCITE_BOOTS = ITEMS.register(Keys.VOLUCITE_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.BOOTS).rarity(AerialHellRarities.VIBRANT.getValue())));

    public static final DeferredItem<Item> MAGMATIC_GEL_HELMET = ITEMS.register(Keys.MAGMATIC_GEL_HELMET.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HELMET).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.HELMET).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));
    public static final DeferredItem<Item> MAGMATIC_GEL_CHESTPLATE = ITEMS.register(Keys.MAGMATIC_GEL_CHESTPLATE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.CHESTPLATE).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));
    public static final DeferredItem<Item> MAGMATIC_GEL_LEGGINGS = ITEMS.register(Keys.MAGMATIC_GEL_LEGGINGS.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.LEGGINGS).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));
    public static final DeferredItem<Item> MAGMATIC_GEL_BOOTS = ITEMS.register(Keys.MAGMATIC_GEL_BOOTS.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_BOOTS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.BOOTS).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));

    public static final DeferredItem<Item> LUNATIC_HELMET = ITEMS.register(Keys.LUNATIC_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_HELMET).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.HELMET).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> LUNATIC_CHESTPLATE = ITEMS.register(Keys.LUNATIC_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.CHESTPLATE).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> LUNATIC_LEGGINGS = ITEMS.register(Keys.LUNATIC_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.LEGGINGS).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> LUNATIC_BOOTS = ITEMS.register(Keys.LUNATIC_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_BOOTS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.BOOTS).rarity(AerialHellRarities.LEGENDARY.getValue())));

    public static final DeferredItem<Item> ARSONIST_HELMET = ITEMS.register(Keys.ARSONIST_HELMET.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_HELMET).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.HELMET).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));
    public static final DeferredItem<Item> ARSONIST_CHESTPLATE = ITEMS.register(Keys.ARSONIST_CHESTPLATE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.CHESTPLATE).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));
    public static final DeferredItem<Item> ARSONIST_LEGGINGS = ITEMS.register(Keys.ARSONIST_LEGGINGS.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.LEGGINGS).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));
    public static final DeferredItem<Item> ARSONIST_BOOTS = ITEMS.register(Keys.ARSONIST_BOOTS.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_BOOTS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.BOOTS).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));

    public static final DeferredItem<Item> SHADOW_HELMET = ITEMS.register(Keys.SHADOW_HELMET.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_HELMET).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.HELMET).rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> SHADOW_CHESTPLATE = ITEMS.register(Keys.SHADOW_CHESTPLATE.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.CHESTPLATE).rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> SHADOW_LEGGINGS = ITEMS.register(Keys.SHADOW_LEGGINGS.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.LEGGINGS).rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> SHADOW_BOOTS = ITEMS.register(Keys.SHADOW_BOOTS.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_BOOTS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.BOOTS).rarity(AerialHellRarities.CORRUPTED.getValue())));

    //effect totems
    public static final DeferredItem<Item> REGENERATION_TOTEM = ITEMS.register(Keys.REGENERATION_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.REGENERATION_TOTEM).stacksTo(1).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.REGENERATION_TOTEM))));
    public static final DeferredItem<Item> SPEED_TOTEM = ITEMS.register(Keys.SPEED_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SPEED_TOTEM).stacksTo(1).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SPEED_TOTEM))));
    public static final DeferredItem<Item> SPEED_II_TOTEM = ITEMS.register(Keys.SPEED_II_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SPEED_II_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL.getValue()).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SPEED_II_TOTEM))));
    public static final DeferredItem<Item> NIGHT_VISION_TOTEM = ITEMS.register(Keys.NIGHT_VISION_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.NIGHT_VISION_TOTEM).stacksTo(1).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.NIGHT_VISION_TOTEM))));
    public static final DeferredItem<Item> AGILITY_TOTEM = ITEMS.register(Keys.AGILITY_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AGILITY_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL.getValue()).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.AGILITY_TOTEM))));
    public static final DeferredItem<Item> HERO_TOTEM = ITEMS.register(Keys.HERO_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HERO_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.HERO_TOTEM))));
    public static final DeferredItem<Item> HEAD_IN_THE_CLOUDS_TOTEM = ITEMS.register(Keys.HEAD_IN_THE_CLOUDS_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HEAD_IN_THE_CLOUDS_TOTEM).stacksTo(1).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.HEAD_IN_THE_CLOUDS_TOTEM))));
    public static final DeferredItem<Item> GOD_TOTEM = ITEMS.register(Keys.GOD_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.GOD_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL.getValue()).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.GOD_TOTEM))));
    public static final DeferredItem<Item> CURSED_TOTEM = ITEMS.register(Keys.CURSED_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.CURSED_TOTEM))));
    public static final DeferredItem<Item> SHADOW_TOTEM = ITEMS.register(Keys.SHADOW_TOTEM.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SHADOW_TOTEM).stacksTo(1).rarity(AerialHellRarities.CORRUPTED.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SHADOW_TOTEM))));
